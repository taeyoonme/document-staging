...
![](../../../.gitbook/assets/corpus-inspection5.png)
...
<br>
다음의 [작성 가이드](/nugu-play/create-plays-with-play-builder/define-user-utterance-model/how-to-write-customer-utterances.md)에 따라 구성되어야, Play가 사용자의 말을 더 잘 이해할 수 있습니다.
{% endhint %}

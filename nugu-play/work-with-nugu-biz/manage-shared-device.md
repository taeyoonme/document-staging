...
NUGU 디바이스를 사무 공간, 호텔, 병원 등 다양한 공용 공간에서 목적에 맞게 사용 가능합니다. NUGU 디바이스 설치 후 전용 디바이스로 등록/설정하면, NUGU 개인 계정과 연결없이 해당 공간에서 누구나 사용 가능합니다.
...
2️⃣디바이스 그룹 생성 팝업에서 생성할 디바이스 그룹의 기본 정보\(디바이스 그룹명, 디바이스 그룹 설명, 주소\)를 입력하고 `그룹 생성하기` 버튼을 클릭하면 그룹이 생성됩니다.

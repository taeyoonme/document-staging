필수 Entity 정의하기(Slot-Filling Prompt) {#slot-filling-prompt}
====================

User Utterance Model을 정의하다 보면 사용자로부터 추가로 정보를 받아야만 처리할 수 있는 Intent가 있을 수 있습니다.
가령, 알람을 맞춰달라는 Intent를 처리하고자 한다면, '몇 시'라는 정보(Entity)가 꼭 필요합니다.
...
{% hint style='tip' %}
Utterance Parameter 등록 및 매핑에 대한 자세한 내용은 [Parameter 사용하기](/create-plays-with-play-builder/use-parameters.md)를 참고하세요.
{% endhint %}
...
![](../images/create-plays-with-play-builder/ch3_32331_c01.png)
3. 이후 Slot-filling Prompt를 입력합니다.
![](../images/create-plays-with-play-builder/ch3_32331_c02.gif)

Slot-filling Prompt는 다른 Prompt와 달리 마지막 발화부터 입력하는 스택 구조이며 LIFO(Last In First Out)로 동작합니다.
여러 개의 Prompt를 입력하면 가장 마지막에 입력한 Prompt부터 차례대로 사용자에게 응답하게 됩니다.
...
{% hint style='tip' %}
**종료 Prompt**에 대한 자세한 내용은 [Prompt의 유형](/create-plays-with-play-builder/use-prompts.md#prompt-types)을 참고하세요.
{% endhint %}


![](../images/create-plays-with-play-builder/ch3_32331_c03.gif)
...
{% hint style='example' %}
주소를 입력 받는 경우 연속된 숫자나 1음절 숫자는 인식하기 어려울 수 있습니다. <br>

전화번호나 비밀번호를 입력 받는 경우(숫자 개개를 정확히 인식하기 어려움) <br>

Play Builder로 Play 만들기 {#create-plays-with-play-builder}
====================
...
![](../images/create-plays-with-play-builder/ch3_00_01.png)
<br>
#### 2. 이 기능을 이용하기 위해 사용자가 어떻게 말할지를 예측합니다.

정의된 문장들을 기반으로 Play Builder가 NLU 엔진을 학습시키며, NLU 엔진은 실제 사용자의 발화를 분석하여 어떤 의도가 있는지를 판단합니다.

![](../images/create-plays-with-play-builder/ch3_00_02.png)
<br>
#### 3. Play에 기능을 구현하여, 사용자의 의도에 맞는 적절한 응답을 할 수 있도록 정의합니다.

응답은 음성 답변으로만 구현할 수 있으며, 특정 동작을 수행하거나 미디어를 컨트롤하는 등의 명령을 정의할 수도 있습니다.

![](../images/create-plays-with-play-builder/ch3_00_03.png)

<br><br>

단계별로 조금 더 상세히 살펴보면 다음과 같습니다. 

  ![](../images/create-plays-with-play-builder/ch3_32_01_2.png)


다음 장([아리아, 안녕!](/create-plays-with-play-builder/hello-aria.md))에서는 Play 만드는 법에 대해 간단하게 설명하고, 이후 각 과정에 대해 순서대로 상세하게 설명합니다. 
...
![](../images/create-plays-with-play-builder/ch3_32_c01_2.png)
{% endhint %}
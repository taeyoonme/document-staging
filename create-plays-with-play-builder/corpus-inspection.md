...
![](../images/create-plays-with-play-builder/corpus-inspection2.png)

훈련 데이터를 구성할 때 이와 같이 동일한 문장을 다르게 Entity 태깅한 경우, `중복 태깅 찾기` 도구는 아래와 같이 분석을 하게 됩니다. 이 경우에는, 두 문장 중 하나를 삭제해야만 정상적인 결과를 얻을 수 있습니다. 
![](../images/create-plays-with-play-builder/corpus-inspection1.png)

<br>
아래의 예와 같이 같은 문장이 서로 다른 Intent에서 다른 Entity 태깅이 된 경우도 중복태깅으로 간주하여 `중복 태깅 찾기`도구는 해당 문장을 찾아내게 됩니다. 

![](../images/create-plays-with-play-builder/corpus-inspection3.png)
![](../images/create-plays-with-play-builder/corpus-inspection4.png)


<br>

## 훈련/결과 불일치 문장 찾기 {#not-matched}
...
![](../images/create-plays-with-play-builder/corpus-inspection5.png)
...
<br>
다음의 [작성 가이드](/create-plays-with-play-builder/how-to-write-customer-utterances.md)에 따라 구성되어야, Play가 사용자의 말을 더 잘 이해할 수 있습니다.
{% endhint %}

Response + Branch Actions (멀티턴 대화 구성하기) {#response-with-branch-actions}
====================
...
![](../images/create-plays-with-play-builder/ch3_intent_branch_menu.png)
...
## Branch Action의 특성{#multi-turn-branch}
...
![](../images/create-plays-with-play-builder/ch3_intent_branch_entity.png)
...
![](../images/create-plays-with-play-builder/ch3_intent_branch_example.png)

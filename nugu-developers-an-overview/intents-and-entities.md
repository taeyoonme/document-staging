Intent와 Entity {#intents-and-entities}
===============
...
{% hint style='tip' %}
의도와 기능에 대한 자세한 내용은 [Play](/nugu-developers-an-overview/play.md)를 참고하세요.
{% endhint %}
...
{% hint style='tip' %}
User Utterance Model 모델에 대한 자세한 내용은 [User Utterance Model 정의하기(Intent & Entity)](/create-plays-with-play-builder/define-user-utterance-model.md)를 참고하세요.
{% endhint %}
...
**Entity Type**은 특정 Entity들의 집합 또는 그 범주를 의미하며, <br>
**Entity Role**은 특정 Entity의 발화 문장에서의 역할을 의미합니다.

![](/images/nugu-developers-an-overview/ch1_112_01.png)
...
![](/images/nugu-developers-an-overview/ch1_112_02.png)
...
![](/images/nugu-developers-an-overview/ch1_112_03.png)
...
![](/images/nugu-developers-an-overview/ch1_112_04.png)
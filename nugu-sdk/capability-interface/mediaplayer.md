...
| :--- | :--- | :--- | :--- |
| token | string | Y | Directive에서 전달한 token |
| message | string | Y | 임의의 string으로 특정 정보를 전달하여 Play에서 활용하고자 하는 경우 사용 가능  - **shuffleOn** : 셔플 on  - **shuffleOff** : 셔플 of  - **repeatSongOn** : 곡 반복 on  - **repeatAllOn** : 전체 반복 on  - **repeatOff** : 반복 해제  - **addLikeSong** : 좋아요 추가 성공  - **removeLikeSong** : 좋아요 제거 성공 |

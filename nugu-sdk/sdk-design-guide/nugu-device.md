...
{% file src="../../.gitbook/assets/start\_listening\_500ms-1 \(1\).wav" caption="호출 효과음" %}
...
{% file src="../../.gitbook/assets/end\_listening\_500ms \(1\).wav" caption="인식 완료음" %}
...
{% file src="../../.gitbook/assets/responsefail\_500ms \(2\).wav" caption="응답 실패음" %}
